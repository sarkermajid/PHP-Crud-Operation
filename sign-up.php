...
<body class="bg-dark">
    <h1 class="display-3 text-warning text-center">Signup Form</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <form action="sign-up-v.php" method="POST">
                ...
                <br>
                <button type="submit"><a class="btn btn-danger text-center w-100 mt-3" href="allusers.php">Add student</a></button>
                <a class="btn btn-danger text-center w-100 mt-3" href="index.php">Back</a>
                <h5 class="mt-4 text-center mb-2 text-white">If You have An Account ! Please <a class="text-success" href="login.php">Login</a></h5>
            </form>
            </div>
            <div class="col-lg-3"></div>
        </div>
